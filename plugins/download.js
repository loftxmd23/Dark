...
cmd({
  ...
  try {
    ...
    const caption = `╭━━━〔 * 𝐷𝛥𝑅𝛫 𝛭𝛥𝑇𝑅𝛪𝛸 TWITTER DOWNLOADER* 〕━━━⊷\n`
...
cmd({
  ...
  try {
    ...
    const caption = `╭━━━〔 *𝐷𝛥𝑅𝛫 𝛭𝛥𝑇𝑅𝛪𝛸 MEDIAFIRE DOWNLOADER* 〕━━━⊷\n`
      + `┃▸ *File Name:* ${file_name}\n`
      + `┃▸ *File Type:* ${mime_type}\n`
      + `╰━━━⪼\n\n`
...
cmd({
  ...
  try {
    ...
    const caption = `╭━━━〔 *𝐷𝛥𝑅𝛫 𝛭𝛥𝑇𝑅𝛪𝛸 APK Downloader* 〕━━━┈⊷
┃ 📦 *Name:* ${app.name}
┃ 🏋 *Size:* ${appSize} MB
┃ 📦 *Package:* ${app.package}
